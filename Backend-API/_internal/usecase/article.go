...
func (u *usecase) InsertArticle(ctx context.Context, title string, slug string, htmlcontent string, categoryid int) ([]interface{}, error) {
	var (
		article     []interface{}
...
func (u *usecase) UpdateArticle(ctx context.Context, id int, title string, slug string, htmlcontent string, categoryid int) ([]interface{}, error) {
	var (
		article        []interface{}
