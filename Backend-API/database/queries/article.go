...
const (
	...
	INSERT_ARTICLE = `INSERT INTO cms_article (title, slug, html_content, category_id, created_at, updated_at) 
                  VALUES ($1, $2, $3, $4, $5, $6) RETURNING id`

	UPDATE_ARTICLE = `UPDATE cms_article SET title = $1, slug = $2, html_content = $3, category_id = $4, updated_at = $5 
                  WHERE id = $6`
